...
keys.mousebinding = gears.table.join(
    awful.button({}, 3,
        function()
            mymainmenu:toggle()
        end
...
keys.globalkeys = gears.table.join(
    ...
    awful.key({superkey, shiftkey}, returnkey,
        function()
            awful.spawn(terminal, {floating = true})
        end,
        {
            description = "open a floating terimnal",
            group = "launcher"
        }
    ),
    ...
    awful.key({},"XF86AudioRaiseVolume",
        function ()
            awful.spawn.with_shell("amixer set Master 5%+,5%+")
        end,
        {
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({superkey, ctrlkey}, returnkey,
        function(c)
